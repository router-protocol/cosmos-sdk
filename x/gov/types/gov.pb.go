...
func (m *Proposal2) Reset()      { *m = Proposal2{} }
func (*Proposal2) ProtoMessage() {}
func (*Proposal2) Descriptor() ([]byte, []int) {
	return fileDescriptor_6e82113c1a9a4b7c, []int{4}
}
func (m *Proposal2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Proposal2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Proposal2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Proposal2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Proposal2.Merge(m, src)
}
func (m *Proposal2) XXX_Size() int {
	return m.Size()
}
func (m *Proposal2) XXX_DiscardUnknown() {
	xxx_messageInfo_Proposal2.DiscardUnknown(m)
}

var xxx_messageInfo_Proposal2 proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*Proposal2)(nil), "cosmos.gov.v1beta1.Proposal2")
...
var fileDescriptor_6e82113c1a9a4b7c = []byte{
	...
	,
}
...
func (this *Proposal2) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Proposal2)
	if !ok {
		that2, ok := that.(Proposal2)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *Proposal2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Proposal2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Proposal2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Proposal2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Proposal2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Proposal2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
